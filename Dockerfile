...
RUN echo "deb [signed-by=/etc/apt/keyrings/firefox.gpg] https://ppa.launchpadcontent.net/mozillateam/ppa/ubuntu jammy main" >> /etc/apt/sources.list.d/nodesource.list && \
